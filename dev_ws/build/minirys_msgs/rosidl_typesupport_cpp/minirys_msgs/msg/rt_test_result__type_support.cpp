...
static const _RTTestResult_type_support_symbol_names_t _RTTestResult_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, minirys_msgs, msg, RTTestResult)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, minirys_msgs, msg, RTTestResult)),
  }
};
...
{
  return &::minirys_msgs::msg::rosidl_typesupport_cpp::RTTestResult_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, minirys_msgs, msg, RTTestResult)() {
  return get_message_type_support_handle<minirys_msgs::msg::RTTestResult>();
}
