...
class Metaclass_SetPose(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from minirys_msgs.srv import _set_pose
...
class SetPose(metaclass=Metaclass_SetPose):
    from minirys_msgs.srv._set_pose import SetPose_Request as Request
    from minirys_msgs.srv._set_pose import SetPose_Response as Response
