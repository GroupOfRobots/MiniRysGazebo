...
#include "minirys_msgs/srv/detail/set_pose__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const minirys_msgs::srv::SetPose_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  minirys_msgs::srv::SetPose_Request & ros_message)
{
  // Member: pose
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = minirys_msgs::srv::SetPose_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const minirys_msgs::srv::SetPose_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<minirys_msgs::srv::SetPose_Request *>(
    untyped_ros_message);
...
{
  return &minirys_msgs::srv::typesupport_fastrtps_cpp::_SetPose_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, minirys_msgs, srv, SetPose_Request)() {
  return &minirys_msgs::srv::typesupport_fastrtps_cpp::_SetPose_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_minirys_msgs
cdr_serialize(
  const minirys_msgs::srv::SetPose_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  minirys_msgs::srv::SetPose_Response & ros_message)
{
  // Member: structure_needs_at_least_one_member
  cdr >> ros_message.structure_needs_at_least_one_member;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = minirys_msgs::srv::SetPose_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const minirys_msgs::srv::SetPose_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<minirys_msgs::srv::SetPose_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &minirys_msgs::srv::typesupport_fastrtps_cpp::_SetPose_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, minirys_msgs, srv, SetPose_Response)() {
  return &minirys_msgs::srv::typesupport_fastrtps_cpp::_SetPose_Response__handle;
}
...
{
  return &minirys_msgs::srv::typesupport_fastrtps_cpp::_SetPose__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, minirys_msgs, srv, SetPose)() {
  return &minirys_msgs::srv::typesupport_fastrtps_cpp::_SetPose__handle;
}
