...
#include "minirys_msgs/msg/detail/motor_command__rosidl_typesupport_fastrtps_c.h"
...
using _MotorCommand__ros_msg_type = minirys_msgs__msg__MotorCommand;
...
size_t get_serialized_size_minirys_msgs__msg__MotorCommand(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _MotorCommand__ros_msg_type * ros_message = static_cast<const _MotorCommand__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _MotorCommand__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_minirys_msgs__msg__MotorCommand(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_minirys_msgs
size_t max_serialized_size_minirys_msgs__msg__MotorCommand(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = minirys_msgs__msg__MotorCommand;
    is_plain =
      (
...
static size_t _MotorCommand__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_minirys_msgs__msg__MotorCommand(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, minirys_msgs, msg, MotorCommand)() {
