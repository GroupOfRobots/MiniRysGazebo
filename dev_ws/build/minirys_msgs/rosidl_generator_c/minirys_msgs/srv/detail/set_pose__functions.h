...
#ifndef MINIRYS_MSGS__SRV__DETAIL__SET_POSE__FUNCTIONS_H_
#define MINIRYS_MSGS__SRV__DETAIL__SET_POSE__FUNCTIONS_H_
 ...
 * calls
 * minirys_msgs__srv__SetPose_Request__init().
...
/**
 * It calls
 * minirys_msgs__srv__SetPose_Request__fini()
 ...
 * minirys_msgs__srv__SetPose_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * minirys_msgs__srv__SetPose_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * minirys_msgs__srv__SetPose_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_minirys_msgs
...
/**
 * It calls
 * minirys_msgs__srv__SetPose_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_minirys_msgs
...
/**
 * It allocates the memory for the array and calls
 * minirys_msgs__srv__SetPose_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_minirys_msgs
...
/**
 * It calls
 * minirys_msgs__srv__SetPose_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // MINIRYS_MSGS__SRV__DETAIL__SET_POSE__FUNCTIONS_H_
